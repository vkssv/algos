...
analyser - программная реализация простейшего парсера AST,
...
Как только функция get_fib_index(num) находит число из ряда
Фибоначчи большее входного аргумента num, она сразу возвращает
его индекс. Таким образом, попыталась реализовать условие
получения заменяемого значения массива и возможного остатка
(условие из пункта #3).
